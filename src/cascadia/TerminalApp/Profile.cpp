...
static const std::wstring_view NAME_KEY{ L"name" };
static const std::wstring_view GUID_KEY{ L"guid" };
static const std::wstring_view COLORSCHEME_KEY{ L"colorscheme" };

static const std::wstring_view FOREGROUND_KEY{ L"foreground" };
static const std::wstring_view BACKGROUND_KEY{ L"background" };
static const std::wstring_view COLORTABLE_KEY{ L"colorTable" };
static const std::wstring_view HISTORYSIZE_KEY{ L"historySize" };
static const std::wstring_view SNAPONINPUT_KEY{ L"snapOnInput" };
static const std::wstring_view CURSORCOLOR_KEY{ L"cursorColor" };
static const std::wstring_view CURSORSHAPE_KEY{ L"cursorShape" };
static const std::wstring_view CURSORHEIGHT_KEY{ L"cursorHeight" };

static const std::wstring_view COMMANDLINE_KEY{ L"commandline" };
static const std::wstring_view FONTFACE_KEY{ L"fontFace" };
static const std::wstring_view FONTSIZE_KEY{ L"fontSize" };
static const std::wstring_view ACRYLICTRANSPARENCY_KEY{ L"acrylicOpacity" };
static const std::wstring_view USEACRYLIC_KEY{ L"useAcrylic" };
static const std::wstring_view SCROLLBARSTATE_KEY{ L"scrollbarState" };
static const std::wstring_view CLOSEONEXIT_KEY{ L"closeOnExit" };
static const std::wstring_view PADDING_KEY{ L"padding" };
static const std::wstring_view STARTINGDIRECTORY_KEY{ L"startingDirectory" };
static const std::wstring_view ICON_KEY{ L"icon" };

// Possible values for Scrollbar state
static const std::wstring_view ALWAYS_VISIBLE{ L"visible" };
static const std::wstring_view ALWAYS_HIDE{ L"hidden" };

// Possible values for Cursor Shape
static const std::wstring_view CURSORSHAPE_VINTAGE{ L"vintage" };
static const std::wstring_view CURSORSHAPE_BAR{ L"bar" };
static const std::wstring_view CURSORSHAPE_UNDERSCORE{ L"underscore" };
static const std::wstring_view CURSORSHAPE_FILLEDBOX{ L"filledBox" };
static const std::wstring_view CURSORSHAPE_EMPTYBOX{ L"emptyBox" };
