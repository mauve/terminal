...
static const std::wstring_view FILENAME { L"profiles.json" };
static const std::wstring_view SETTINGS_FOLDER_NAME{ L"\\Microsoft\\Windows Terminal\\" };

static const std::wstring_view PROFILES_KEY{ L"profiles" };
static const std::wstring_view KEYBINDINGS_KEY{ L"keybindings" };
static const std::wstring_view SCHEMES_KEY{ L"schemes" };
