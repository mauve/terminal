...
static const std::wstring_view DEFAULTPROFILE_KEY{ L"defaultProfile" };
static const std::wstring_view ALWAYS_SHOW_TABS_KEY{ L"alwaysShowTabs" };
static const std::wstring_view INITIALROWS_KEY{ L"initialRows" };
static const std::wstring_view INITIALCOLS_KEY{ L"initialCols" };
static const std::wstring_view SHOW_TITLE_IN_TITLEBAR_KEY{ L"showTerminalTitleInTitlebar" };
static const std::wstring_view REQUESTED_THEME_KEY{ L"requestedTheme" };

static const std::wstring_view SHOW_TABS_IN_TITLEBAR_KEY{ L"experimental_showTabsInTitlebar" };

static const std::wstring_view LIGHT_THEME_VALUE{ L"light" };
static const std::wstring_view DARK_THEME_VALUE{ L"dark" };
static const std::wstring_view SYSTEM_THEME_VALUE{ L"system" };
